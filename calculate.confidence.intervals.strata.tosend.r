calculate.confidence.intervals.strata.tosend = function (species=species, data.yrs) {
#-----------------------------------------------------------------
#browser()
...
#-------------------------------------------------------------------------------------------------------
  ...
  ci.boot.gini <- quantile(gini, probs = c(alpha.b/2, (1 - alpha.b/2), 0.5), na.rm=T)
