calculate.confidence.intervals.strata.p = function (species=species, data.yrs) {
#-----------------------------------------------------------------
#browser()
#methods for calculating confidence intervals for grounfish survey estimates
#based on a paper by Smith (1997) 
  
#"Bootstrap confidence limits for groundfish trawl survey estimates of mean abundance. Can. J. Fish. Aquat. Sci.
#Script uses the mirror match bootstrap method (BWR), which was shown to perform better on average with respect to accuracy of the confidence
#intervals being estimated. 
#three methods were originally used to calculate confidence intervals in the paper, and Bias Corrected (BC) was used in this script
...
#summer strata
#k = k[k$strat %in% c('441','443','454','463','472','483','405','440','446','451','460',
#                     '484','409','447','453','462','465','470','475','477','491','410',
#                     '445','450','452','459','467','468','471','485','494','495','404',
#                     '442','469','474','480','476','478','481','482','401','411','444',
#                     '449','455','458','461','464','490','403','406','407','408','448',
#                     '456','457','466','473','492','493'), ]
...
#convert strata area to trawlable units divide area by 0.011801 (41ft by 1.75 nm)
...
#Choose the name to include in the output file variable to plot
variable.n = "totno_sd"
...
#Add all the calculated values to a variable

Yst = yst * sum(Nh) #population total
...
#-------------------------------------------------------------------------------------------------------
  ...
  ci.boot.gini <- quantile(gini.i, probs = c(alpha.b/2, (1 - alpha.b/2), 0.5), na.rm=T)
